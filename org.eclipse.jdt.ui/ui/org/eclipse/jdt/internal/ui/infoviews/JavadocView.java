...
public class JavadocView extends AbstractInfoView {
	...
	/**
	 * Flag to temporarily force isOgnoringNewInput() to return <code>false</code>
	 */
	...
	protected void fillToolBar(IToolBarManager tbm) {
		...
		if (fIsUsingBrowserWidget) {
			...
			Runnable viewRefreshTask = () -> {
				...
				setLinkingEnabled(isLinkingEnabled()); // hack to trigger refresh of the view using last set selection
			};
